...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/VeerCli")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/RSAIEDBOT")],[InlineKeyboardButton("جميع قنواتنا 💜", url="t.me/SAIEDCH/20")]])
